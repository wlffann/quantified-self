...
function addDeleteFunctionality(){
  $("td.food-delete button").on('click', function(){
    ...
    var revisedFoodItems = removeFromLocalStorage(item, foodItems)

    updateLocalStorage(revisedFoodItems)
...
function removeFromLocalStorage(item, foodItems){
...
function updateLocalStorage(revisedFoodItems) {
  foodItemsJSON = JSON.stringify(revisedFoodItems);
  localStorage.setItem('food-items', foodItemsJSON);
}
